...
\subsection*{Extended 30-Epoch Cached-Head Analysis}
...
This extended analysis produced 30 real epoch points for Swin-Tiny and 30 real epoch points for Swin-Small. Swin-Tiny ended at 71.75\% test accuracy on the balanced subset, and Swin-Small ended at 74.25\%. The curves show rapid early improvement followed by a plateau, which supports the main conclusion that pretrained Swin features are strong and that most of the short-run gain comes from learning the classifier head.
